...
Answer is 50% of houses are smaller than 1,499.69
...
Each element represents a mean square footage from a simple random sample
...
The variability of the sampling distributions with the smaller sample size.
