...
Median would be more reliable as it is skewed
...
There is an overall positive relation between distance and avg_speed
...
nycflights %>%
  summarise(ot_arr_rate = sum((dep_type == "delayed" && arr_type == "on time") / sum(dep_type == "delayed")))
